...
class PlayConsoleWorkspace(Base):
    ...
    __tablename__ = "play_console_workspace"

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    package_name: Mapped[str] = mapped_column(String(128), nullable=False, default="com.Doviz")
    ...
    rating_summary_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
