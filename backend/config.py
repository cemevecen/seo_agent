...
class Settings(BaseSettings):
    ...
    ga4_realtime_interval_minutes: int = 5          # Backend alarm job: 5dk (alarm tespiti daha hızlı)
    ga4_realtime_window_minutes: int = 30            # KPI karşılaştırma penceresi: 30dk (15+15 yarı)
