...
class Settings(BaseSettings):
    ...
    # 365 + ~90–100: "son 3 ay vs previous year" penceresi rolling 12m dışında kalmasın.
    ga4_trend_12m_days: int = 500
    ...
    market_sheets_startup_sync_enabled: bool = False
    ...
    ga4_realtime_email_batch_interval_minutes: int = Field(default=180, ge=30, le=480)
