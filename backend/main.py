...
def on_startup() -> None:
    ...
    global SCHEDULER
    # Railway deploy log'larında kolayca görülebilecek bir işaret.
    print("STARTUP_NONBLOCKING_READY")  # noqa: T201

    def _startup_work() -> None:
        global SCHEDULER
        try:
            print("STARTUP_BG_THREAD_BEGIN")  # noqa: T201
...
@app.post("/search-console")
def search_console_page_post():
    # Deploy sırasında kullanıcı etkileşimi ile yanlışlıkla POST gelebiliyor.
    # UI endpoint'i GET olduğundan, POST'u güvenli şekilde GET'e yönlendir.
    return RedirectResponse("/search-console", status_code=303)
