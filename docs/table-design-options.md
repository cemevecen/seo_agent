...
- Hangisi seçildi: **#6 Heat** + **#3 Pin** (varsayılan açık) + **eksen değiştir** (Metrics on top ↔ Dates on top) + **#8 Sürükle** + liste kartı seçili sütunlara **eşit en/boy** (sağ boşluk yok)
