...
STATISTICS_VIEWS: list[dict[str, Any]] = [
    ...
    {
        "id": "device_first_open",
        "label": "Cihaz ilk açılışları",
        "metric_key": "device_first_open",
        "metrics": "DEVICE_FIRST_OPEN-ALL-EVENTS-PER_INTERVAL-DAY",
        "dimension": "COUNTRY",
        "dimension_values": "OVERALL%2CTR%2CDE%2CFR%2CNL",
        "needles": ("İlk açılış", "First open", "Cihaz ilk", "İstatistik", "Veri tablosu"),
    },
    {
        "id": "user_lost",
    ...
    },
    {
        ...
        "label": "Alıcı sayısı",
        "metric_key": "buyers",
        "metrics": "BUYERS-ALL-UNIQUE-PER_INTERVAL-DAY",
        "dimension": "COUNTRY",
        "dimension_values": "OVERALL",
        "needles": ("Alıcı", "Buyer", "İstatistik", "Veri tablosu"),
    },
    {
        "id": "arppu",
        "label": "ÖYKBOG (ARPPU)",
        "metric_key": "arppu",
        "metrics": "ARPPU-ACQUISITION_UNSPECIFIED-COUNT_UNSPECIFIED-PER_INTERVAL-DAY",
        "dimension": "COUNTRY",
        "dimension_values": "OVERALL",
        "needles": ("ÖYKBOG", "ARPPU", "Alıcı", "İstatistik", "Veri tablosu"),
    },
    {
        "id": "ar2_visitors",
